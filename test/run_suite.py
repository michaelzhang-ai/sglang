...
NIGHTLY_SUITES = {
    ...
    HWBackend.AMD: [
        ...
        "nightly-amd-accuracy-2-gpu-vlm",
        "nightly-amd-perf-text-2-gpu",
        "nightly-amd-perf-vlm-2-gpu",
        "nightly-amd-accuracy-8-gpu-gpt-oss",
        "nightly-amd-accuracy-8-gpu-grok1-fp8",
        "nightly-amd-accuracy-8-gpu-grok1-int4",
        "nightly-amd-accuracy-8-gpu-grok2",
        "nightly-amd-accuracy-8-gpu-deepseek-v31",
        "nightly-amd-accuracy-8-gpu-deepseek-v32",
        "nightly-amd-accuracy-8-gpu-deepseek-v32-mtp",
        "nightly-amd-accuracy-8-gpu-kimi-k2",
        # MI35x suites
        "nightly-amd-8-gpu-mi35x",
        "nightly-amd-8-gpu-mi35x-deepseek-r1-mxfp4",
        "nightly-amd-8-gpu-mi35x-deepseek-v32",
        "nightly-amd-accuracy-8-gpu-mi35x-grok1-int4",
        "nightly-amd-accuracy-8-gpu-mi35x-grok2",
        "nightly-amd-accuracy-8-gpu-mi35x-deepseek-v32-mtp",
        "nightly-amd-accuracy-8-gpu-mi35x-kimi-k2",
        # Performance suites
        "nightly-perf-8-gpu-grok1-int4",
        "nightly-perf-8-gpu-grok2",
        "nightly-perf-8-gpu-deepseek-v31",
        "nightly-perf-8-gpu-deepseek-v32-basic",
        "nightly-perf-8-gpu-deepseek-v32-mtp",
        "nightly-perf-8-gpu-mi35x-grok1-int4",
        "nightly-perf-8-gpu-mi35x-grok2",
