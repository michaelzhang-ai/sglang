"""AMD Qwen 3.5 MGSM-EN Chat Evaluation Test (8-GPU)

Tests Qwen/Qwen3.5-397B-A17B (MoE, Hybrid Attention with Gated Delta Networks)
with MGSM-EN chat completion benchmark on MI325/MI300X.
...
register_amd_ci(
    est_time=3600, suite="nightly-amd-accuracy-8-gpu-qwen35", nightly=True
)
...
class TestQwen35EvalAMD(CustomTestCase):
    """Qwen 3.5 MGSM-EN Chat Evaluation Test for AMD MI325/MI300X."""
